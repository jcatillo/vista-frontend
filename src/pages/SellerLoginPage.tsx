      ...
      <div className="z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="border-vista-surface/30 hover:border-vista-surface focus-within:border-vista-accent relative flex items-center rounded-xl border bg-vista-bg/30 transition-colors">
        ...
        <motion.div
          ...
          className="bg-vista-surface/50 mt-6 rounded-xl p-4 text-center"
        >
